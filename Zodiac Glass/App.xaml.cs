namespace ZodiacGlass
{
    ...
    public partial class App : Application
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private const string XIV_DX11_ProcessName = "ffxiv_dx11"; // ffxiv_dx11 for DirectX 11 (but ffxiv_dx11 is a x64 process and has different mem addresses)
        ...
        private void ReadFFXIVConfig()
        {
            try
            {
                using (FFXIVConfigReader reader = new FFXIVConfigReader(Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments), @"My Games\FINAL FANTASY XIV - KOREA\FFXIV.cfg")))
                {
        ...
        private void AttachToExistingProcesses()
        {
            ...
            this.log.Write(LogLevel.Info, "GetProcessesByName(FFXIV) : " + processes.Count().ToString());
            ...
            case 1:
                ...
                this.log.Write(LogLevel.Info, "CreateOverlay() SingleProcess : " + singleProcess.MainModule.ToString());
            ...
            default:
                ...
                foreach (Process process in processes)
                {
                    ...
                    this.log.Write(LogLevel.Info, "CreateOverlay() Processes : " + process.MainModule.ToString());
                }

                    break;
            }

            var processes2 = Process.GetProcessesByName(App.XIV_DX11_ProcessName).ToArray();
            this.log.Write(LogLevel.Info, "GetProcessesByName(FFXIV_DX11) : " + processes2.Count().ToString());

            switch (processes2.Count())
            {
                case 0:
                ...
                case 1:
                    ...
                    Process singleProcess = processes2.First();
                    this.CreateOverlay(singleProcess);
                    this.log.Write(LogLevel.Info, "CreateOverlay() SingleProcess : " + singleProcess.MainModule.ToString());
        ...
        {
            this.log.Write(LogLevel.Trace, string.Format("Creating overlay for process {0}, {1}.", process.Id, process.MainWindowTitle));
